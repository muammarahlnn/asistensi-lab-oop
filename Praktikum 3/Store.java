...
public class Store {
    ...
    public void transaksi(int n, User user) {
        ...
        //kondisi pertama untuk mengecek apakah stok lebih besar dari 0, jika ya lanjut kekondisi kedua 
        
            //kondisi kedua pengecekan jika balance user lebih besar atau sama dengan harga produk, 
